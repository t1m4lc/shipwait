...
<template>
    <Form v-slot="{ meta, values, validate }" keep-values
        :validation-schema="toTypedSchema(formSchema[stepIndex - 1] || formSchema[0])"
        :initial-values="{
            name: '',
            domain: '',
            ...
            <form @submit="async (e) => {
                    ...
                    <template v-if="stepIndex === 3">
                        <div class="flex flex-col items-center gap-6 py-4">
                            <div class="text-center">
                                ...
                                <p class="text-muted-foreground">
                                2- Add the <code>data-waitly</code> attribute to your email input to bind to Waitly script.
                            </p>
                            </div>
                ...
                <div class="flex items-center justify-between mt-8">
                    ...
                    <div class="flex items-center gap-3" :class="stepIndex === 3 ? 'justify-center w-full' : ''">
                        <Button v-if="stepIndex === 1" :type="meta.valid ? 'button' : 'submit'"
