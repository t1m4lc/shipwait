        ...
        <div class="size-full flex flex-col">
            ...
            <div class="flex gap-2">
              ...
              <AlertDialog v-model:open="deployAlertOpen">
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle
                      >Deploy your landing page?</AlertDialogTitle
                    >
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction @click.prevent="onDeploy"
                      >Yes, deploy!</AlertDialogAction
                    >
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
          ...
          <div class="relative flex-1 font-medium overflow-hidden">
            <Codemirror
              ...
              placeholder="Paste your HTML landing page here..."
              @update:model-value="validateHtmlCode"
            />

            <div class="absolute top-0 right-0 p-4 flex items-center gap-3">
              <Badge
                v-if="validationStatus === 'valid'"
                class="tracking-wider rounded-full bg-accent text-primary-background space-x-1 border border-primary-background"
              >
